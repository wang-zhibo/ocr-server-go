...
type Config struct {
	...
	PreprocessDefault bool          `mapstructure:"preprocess_default" yaml:"preprocess_default"`
}
...
func getConfigFilePath() string {
	homeDir := "."
	return filepath.Join(homeDir, ".ocr-server-go", "config.yaml")
}

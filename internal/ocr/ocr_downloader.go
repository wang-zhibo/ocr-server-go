...
const (
	ocrURL      = "https://github.com/hiroi-sora/PaddleOCR-json/releases/download/v1.4.1/PaddleOCR-json_v1.4.1_debian_x64_glibc2.31.tar.xz"
	ocrFileName = "PaddleOCR-json_v1.4.1_debian_x64_glibc2.31.tar.xz"
	ocrExeName  = "PaddleOCR-json_v1.4.1_debian_x64_glibc2.31/bin/PaddleOCR-json"
	resDir      = "res"
)
